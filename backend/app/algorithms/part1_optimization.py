...
# ========== 设置图片保存路径 ==========
# 使用项目根目录下的 temp 文件夹
SAVE_PATH = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), "temp", "tianchou_images")
...
class IndustryClassifier:
    ...
    def _build_industry_mapping(self):
        ...
        self.industry_mapping = {
            # 重工业行业代码
            'C25': 'heavy', 'C251': 'heavy', 'C2511': 'heavy', 'C2519': 'heavy', 'C252': 'heavy', 'C2521': 'heavy', 'C2522': 'heavy',
            'C26': 'heavy', 'C261': 'heavy', 'C2611': 'heavy', 'C2612': 'heavy', 'C2613': 'heavy', 'C262': 'heavy', 'C2621': 'heavy',
            'C27': 'heavy', 'C271': 'heavy', 'C2710': 'heavy', 'C272': 'heavy', 'C2720': 'heavy',
            'C28': 'heavy', 'C281': 'heavy', 'C2811': 'heavy', 'C2812': 'heavy',
            'C30': 'heavy', 'C301': 'heavy', 'C3011': 'heavy', 'C3012': 'heavy', 'C304': 'heavy', 'C3041': 'heavy', 'C3042': 'heavy',
            'C31': 'heavy', 'C311': 'heavy', 'C3110': 'heavy', 'C312': 'heavy', 'C3120': 'heavy', 'C313': 'heavy', 'C3130': 'heavy',
            'C32': 'heavy', 'C321': 'heavy', 'C3211': 'heavy', 'C3212': 'heavy', 'C325': 'heavy', 'C3251': 'heavy', 'C3252': 'heavy',
            'C33': 'heavy', 'C331': 'heavy', 'C3311': 'heavy', 'C3312': 'heavy', 'C333': 'heavy', 'C3331': 'heavy', 'C3332': 'heavy',
            'C34': 'heavy', 'C341': 'heavy', 'C3411': 'heavy', 'C3412': 'heavy', 'C342': 'heavy', 'C3421': 'heavy', 'C3422': 'heavy',
            'C35': 'heavy', 'C351': 'heavy', 'C3511': 'heavy', 'C3512': 'heavy', 'C358': 'heavy', 'C3581': 'heavy', 'C3582': 'heavy',
            'C36': 'heavy', 'C361': 'heavy', 'C3610': 'heavy', 'C362': 'heavy', 'C3620': 'heavy', 'C367': 'heavy', 'C3670': 'heavy',
            'C37': 'heavy', 'C371': 'heavy', 'C3711': 'heavy', 'C3712': 'heavy', 'C373': 'heavy', 'C3731': 'heavy', 'C3732': 'heavy',
            'C381': 'heavy', 'C3811': 'heavy', 'C3812': 'heavy', 'C3813': 'heavy',
            'C382': 'heavy', 'C3821': 'heavy', 'C3822': 'heavy', 'C3823': 'heavy',
            'C383': 'heavy', 'C3831': 'heavy', 'C3832': 'heavy', 'C3833': 'heavy',
            
            # 轻工业行业代码
            'C13': 'light', 'C131': 'light', 'C1310': 'light', 'C132': 'light', 'C1320': 'light', 'C133': 'light', 'C1331': 'light',
            'C14': 'light', 'C141': 'light', 'C1411': 'light', 'C1419': 'light', 'C142': 'light', 'C1421': 'light', 'C1422': 'light',
            'C15': 'light', 'C151': 'light', 'C1511': 'light', 'C1512': 'light', 'C152': 'light', 'C1521': 'light', 'C1522': 'light',
            'C16': 'light', 'C161': 'light', 'C1610': 'light', 'C162': 'light', 'C1620': 'light',
            'C17': 'light', 'C171': 'light', 'C1711': 'light', 'C1712': 'light', 'C172': 'light', 'C1721': 'light', 'C1722': 'light',
            'C18': 'light', 'C181': 'light', 'C1811': 'light', 'C1819': 'light', 'C182': 'light', 'C1821': 'light', 'C1829': 'light',
            'C19': 'light', 'C191': 'light', 'C1910': 'light', 'C192': 'light', 'C1921': 'light', 'C1922': 'light',
            'C21': 'light', 'C211': 'light', 'C2110': 'light', 'C212': 'light', 'C2120': 'light', 'C213': 'light', 'C2130': 'light',
            'C22': 'light', 'C221': 'light', 'C2210': 'light', 'C222': 'light', 'C2221': 'light', 'C2222': 'light',
            'C23': 'light', 'C231': 'light', 'C2311': 'light', 'C2312': 'light', 'C232': 'light', 'C2320': 'light',
            'C24': 'light', 'C241': 'light', 'C2411': 'light', 'C2412': 'light', 'C245': 'light', 'C2450': 'light',
            'C395': 'light', 'C3951': 'light', 'C3952': 'light', 'C3953': 'light',
            'C396': 'light', 'C3961': 'light', 'C3962': 'light', 'C3963': 'light',
            
            # 模糊/需进一步判断的行业代码
            'C29': 'fuzzy', 'C291': 'heavy', 'C2911': 'heavy', 'C2919': 'light', 'C292': 'light', 'C2921': 'light', 'C2923': 'light',
            'C38': 'fuzzy', 'C385': 'fuzzy', 'C3851': 'heavy', 'C3852': 'heavy', 'C3853': 'light', 'C3854': 'light', 'C387': 'light', 'C3871': 'light', 'C3872': 'light',
            'C20': 'fuzzy', 'C201': 'fuzzy', 'C2011': 'heavy', 'C2012': 'light', 'C202': 'heavy', 'C2021': 'heavy', 'C2022': 'heavy', 'C203': 'light', 'C2031': 'fuzzy', 'C2032': 'light',
            'C39': 'fuzzy', 'C391': 'fuzzy', 'C3911': 'fuzzy', 'C3912': 'heavy', 'C392': 'fuzzy', 'C3921': 'heavy', 'C3922': 'light',
            'C40': 'fuzzy', 'C401': 'fuzzy', 'C4011': 'heavy', '4012': 'fuzzy', 'C403': 'light', 'C4030': 'light',
        }
    ...
    def classify_industry(self, industry_code, business_description=""):
        ...
        # 尝试模糊匹配
        code_lengths = sorted(set(len(code) for code in self.industry_mapping.keys()), reverse=True)
    ...
    def _judge_by_description(self, business_description):
        ...
        heavy_keywords = ['钢铁', '冶金', '化工', '机械制造', '设备制造', '重型', '大型设备', 
                         '石油', '煤炭', '金属冶炼', '汽车制造', '船舶', '航空航天', '重型机械']
        
        light_keywords = ['食品', '纺织', '服装', '家具', '造纸', '印刷', '文教', '玩具', 
                         '家用电器', '消费品', '日用', '快速消费品', '时尚']
        ...
        print(f"  关键词匹配: 重工业关键词匹配数={heavy_count}, 轻工业关键词匹配数={light_count}")
...
class SLP_GA_Optimizer:
    ...
    def evaluate_individual(self, individual):
        ...
        for i in range(self.N):
            for j in range(self.N):
                if i != j:
                    ...
                    f1 += self.f_matrix[i, j] * self.w_matrix[i, j] * dist * self.c_transport
            ...
            if devices:
                ...
                for i in range(len(line_positions)):
                    for j in range(i+1, len(line_positions)):
                        avg_distance += self.calculate_distance(line_positions[i], line_positions[j])
        ...
        # 5. 归一化目标值并加权求和
        max_f1 = np.max(self.f_matrix) * np.max(self.w_matrix) * self.c_transport * self.L * self.W * self.N
    ...
    def calculate_constraint_penalty(self, positions):
        ...
        for aisle in self.aisle_areas:
            ...
            for i in range(self.N):
                ...
                overlap_width = max(0, min(device_right, aisle_right) - max(device_left, aisle_x))
                overlap_height = max(0, min(device_top, aisle_top) - max(device_bottom, aisle_y))
    ...
    def mutate_individual(self, individual, generation=None, max_generation=None):
        ...
        for i in self.M:
            if random.random() < current_mutpb:
                mutation_type = random.choice(['small', 'medium', 'large', 'swap', 'reset', 'line_focus'])
    ...
    def find_line_center(self, device_id, positions):
        ...
        for line_id, devices in self.product_lines.items():
            if device_id in devices:
                ...
                if line_devices:
                    center_x = sum(positions[dev][0] for dev in line_devices) / len(line_devices)
                    center_y = sum(positions[dev][1] for dev in line_devices) / len(line_devices)
    ...
    def crossover_individuals(self, ind1, ind2):
        ...
        if random.random() < self.cxpb:
            crossover_type = random.choice(['single', 'two_point', 'uniform', 'blend', 'line_based'])
            ...
            if crossover_type == 'single':
                ...
                for i in self.M:
                    if random.random() < 0.5:
                        ...
                        child1[i] = (max(x_min, min(x_max, new_x1)), 
                                    max(y_min, min(y_max, new_y1)))
                        child2[i] = (max(x_min, min(x_max, new_x2)), 
    ...
    def run_optimization(self):
        ...
        for gen in range(self.ngen):
            ...
            if gen % 20 == 0 or gen == self.ngen - 1:
                ...
                print(f"Generation {gen}: f1={f1:.2f}, f2={f2:.2f}, f3={f3:.4f}, "
        ...
        return self.pareto_solutions, self.all_solutions
    ...
    def calculate_population_diversity(self, population):
        ...
        normalized_diversity = avg_distance / max_possible_distance if max_possible_distance > 0 else 0
    ...
    def get_pareto_front(self, solutions):
        ...
        for sol in solutions:
            pos_hash = tuple((round(pos[0], 2), round(pos[1], 2)) for pos in sol['individual'])
    ...
    def is_dominated(self, sol1, sol2):
        ...
        return (f1_2 <= f1_1 and f2_2 <= f2_1 and f3_2 >= f3_1 and 
                (f1_2 < f1_1 or f2_2 < f2_1 or f3_2 > f3_1))
    ...
    def visualize_results(self):
        ...
        scatter1 = ax1.scatter(f1_vals, f2_vals, alpha=0.2, c=self.colors['all_solutions'], 
                              s=10, edgecolors='none', label='所有解')
        scatter2 = ax1.scatter(f1_pareto, f2_pareto, c=self.colors['pareto_front'], 
                              s=80, marker='*', edgecolors='gold', linewidth=1.5, label='帕累托前沿')
        ax1.set_xlabel('物料搬运成本 (f1)', fontsize=12, fontweight='bold')
        ax1.set_ylabel('设备移动成本 (f2)', fontsize=12, fontweight='bold')
        ax1.set_title('物料搬运成本 vs 设备移动成本', fontsize=14, fontweight='bold', pad=15)
        ax1.legend(loc='best', fontsize=10)
        ax1.grid(True, alpha=0.3, linestyle='--')
        
        ax2 = fig.add_subplot(132)
        ax2.scatter(f1_vals, f3_vals, alpha=0.2, c=self.colors['all_solutions'], 
                   s=10, edgecolors='none')
        ax2.scatter(f1_pareto, f3_pareto, c=self.colors['pareto_front'], 
                   s=80, marker='*', edgecolors='gold', linewidth=1.5)
        ax2.set_xlabel('物料搬运成本 (f1)', fontsize=12, fontweight='bold')
        ax2.set_ylabel('空间利用率 (f3)', fontsize=12, fontweight='bold')
        ax2.set_title('物料搬运成本 vs 空间利用率', fontsize=14, fontweight='bold', pad=15)
        ax2.grid(True, alpha=0.3, linestyle='--')
        
        ax3 = fig.add_subplot(133)
        ax3.scatter(f2_vals, f3_vals, alpha=0.2, c=self.colors['all_solutions'], 
                   s=10, edgecolors='none')
        ax3.scatter(f2_pareto, f3_pareto, c=self.colors['pareto_front'], 
                   s=80, marker='*', edgecolors='gold', linewidth=1.5)
        ax3.set_xlabel('设备移动成本 (f2)', fontsize=12, fontweight='bold')
        ax3.set_ylabel('空间利用率 (f3)', fontsize=12, fontweight='bold')
        ax3.set_title('设备移动成本 vs 空间利用率', fontsize=14, fontweight='bold', pad=15)
        ax3.grid(True, alpha=0.3, linestyle='--')
        
        fig.suptitle('双轨算法 - 帕累托前沿分析 (纺织企业布局优化)', fontsize=16, fontweight='bold', y=0.95)
    ...
    def output_all_pareto_solutions(self):
        ...
        pareto_solutions_sorted = sorted(self.pareto_solutions, key=lambda x: x['total'])
        ...
        for i, sol in enumerate(pareto_solutions_sorted, 1):
                ...
                if devices:
                    ...
                    for j in range(len(positions)):
                        for k in range(j+1, len(positions)):
                            avg_distance += self.calculate_distance(positions[j], positions[k])
                            count += 1
                    if count > 0:
                        avg_distance /= count
            ...
            for j in self.M:
                ...
                if dist > 0.5:
                    ...
                    moved_devices.append((j, device_name, (orig_x, orig_y), (new_x, new_y), dist, move_cost))
            
            if moved_devices:
                print(f"  🚚 设备移动方案（移动{len(moved_devices)}台设备，总移动成本: ¥{total_move_cost:.2f}，总移动距离: {total_move_distance:.2f}米）:")
                # 修改：显示所有移动设备，使用机器名称
                for dev_id, dev_name, orig, new, dist, move_cost in moved_devices:
                    # 格式化位置信息
                    orig_str = f"({orig[0]:.1f}, {orig[1]:.1f})"
                    new_str = f"({new[0]:.1f}, {new[1]:.1f})"
                    print(f"    {dev_name}{dev_id}: {orig_str} → {new_str}, 距离: {dist:.2f}m, 成本: ¥{move_cost:.2f}")
            else:
                print("  ✅ 无设备移动")
    ...
    def visualize_single_layout(self, solution_index=0, show_comparison=True):
        ...
        if show_comparison:
            ...
            # 子图1：原始布局（无图例）
            self._draw_layout(ax1, self.original_positions, '原始布局', 
                             "", solution, show_arrows=False, show_performance=False, show_legend=False)
            
            # 子图2：优化后布局（有图例）
            improvement = ((self.initial_f1 - solution['f1']) / self.initial_f1 * 100) if self.initial_f1 > 0 else 0
            title = f"优化布局 (解 {solution_index})"
            self._draw_layout(ax2, solution['individual'], '优化后布局', title, 
                             solution, show_arrows=True, original_positions=self.original_positions, show_legend=True)
            
            fig.suptitle(f'双轨算法 - 纺织企业设备布局优化对比 (解 {solution_index})',
            ...
            improvement = ((self.initial_f1 - solution['f1']) / self.initial_f1 * 100) if self.initial_f1 > 0 else 0
            title = f"优化布局 (解 {solution_index})"
            self._draw_layout(ax, solution['individual'], '', title, 
                             solution, show_arrows=True, original_positions=self.original_positions, show_legend=True)
            fig.suptitle(f'双轨算法 - 纺织企业优化后设备布局 (解 {solution_index})',
    ...
    def visualize_original_layout(self):
        ...
        self._draw_layout(ax, self.original_positions, '', subtitle, 
                         original_solution, show_arrows=False, show_legend=True, show_performance=True)
        
        fig.suptitle(f'双轨算法 - 纺织企业原始车间布局', 
                    fontsize=18, fontweight='bold', y=0.95)
        ...
        print(f"  🏭 设备总数: {self.N}台 (可移动: {len(self.M)}台, 固定: {len(self.F)}台)")
        
    def _draw_layout(self, ax, positions, title, subtitle, solution, 
                    show_arrows=False, original_positions=None, show_legend=True, show_performance=True):
        """
        绘制单个布局 - 增强版，增加更多车间细节
        """
        ax.clear()
        ...
        # 绘制功能区域
        # 物料存储区
        storage_rect = Rectangle((5, self.W-10), 15, 8, 
                                facecolor=self.colors['storage_area'], 
                                edgecolor='#2980b9', linewidth=2, alpha=0.6)
        ax.add_patch(storage_rect)
        ax.text(12.5, self.W-6, '物料存储区', ha='center', va='center', 
               fontsize=9, fontweight='bold', color='#2c3e50')
        
        # 质检区
        quality_rect = Rectangle((self.L-20, self.W-10), 15, 8, 
                                 facecolor=self.colors['quality_area'], 
                                 edgecolor='#f1c40f', linewidth=2, alpha=0.6)
        ax.add_patch(quality_rect)
        ax.text(self.L-12.5, self.W-6, '质检区', ha='center', va='center', 
               fontsize=9, fontweight='bold', color='#2c3e50')
        
        # 包装区
        packaging_rect = Rectangle((self.L-20, 5), 15, 8, 
                                   facecolor=self.colors['packaging_area'], 
                                   edgecolor='#27ae60', linewidth=2, alpha=0.6)
        ax.add_patch(packaging_rect)
        ax.text(self.L-12.5, 9, '包装区', ha='center', va='center', 
               fontsize=9, fontweight='bold', color='#2c3e50')
        
        # 装货区
        loading_rect = Rectangle((5, 5), 15, 8, 
                                 facecolor=self.colors['loading_area'], 
                                 edgecolor='#e74c3c', linewidth=2, alpha=0.6)
        ax.add_patch(loading_rect)
        ax.text(12.5, 9, '装货区', ha='center', va='center', 
               fontsize=9, fontweight='bold', color='#2c3e50')
        
        # 绘制通道区域
        for aisle in self.aisle_areas:
            aisle_x, aisle_y, aisle_w, aisle_h = aisle
            aisle_rect = Rectangle((aisle_x, aisle_y), aisle_w, aisle_h, 
                                  facecolor=self.colors['aisle'], edgecolor='orange', 
                                  linewidth=2, alpha=0.3, hatch='//')
            ax.add_patch(aisle_rect)
        
        # 绘制传送带示意
        conveyor_y = self.W * 0.5
        ax.plot([25, 50], [conveyor_y, conveyor_y], color=self.colors['conveyor'], 
               linewidth=4, linestyle='-', alpha=0.7, label='传送带')
        ...
        for i in range(self.N):
            ...
            rect = Rectangle((x - width/2, y - height/2), width, height, 
                            ...
                            linewidth=2, alpha=0.8, hatch=hatch)
            ax.add_patch(rect)
            ...
            # 绘制设备工作指示灯
            indicator = Circle((x + width/2 - 0.3, y + height/2 - 0.3), 0.2, 
                              facecolor='green', edgecolor='black', linewidth=1, alpha=0.8)
            ...
            if show_arrows and original_positions is not None and i in self.M:
                ...
                if dist > 0.5:
                    ...
                    arrow = ax.arrow(arrow_start_x, arrow_start_y, arrow_dx, arrow_dy, 
                                    head_width=0.8, head_length=1.0, 
                                    fc=self.colors['arrow'], ec=self.colors['arrow'], 
                    ...
                    ax.text(text_x, text_y, f'{dist:.1f}m', 
                           fontsize=7, color=self.colors['distance_text'],
                           ha='center', va='center',
                           bbox=dict(boxstyle="round,pad=0.2", 
                                   facecolor='white', edgecolor=self.colors['distance_text'],
                                   alpha=0.7))
        ...
        for line_idx, (line_id, devices) in enumerate(self.product_lines.items()):
            ...
            # 绘制产品线标记线
            ax.plot([10, self.L-10], [line_y, line_y], color=line_color, 
            ...
            ax.annotate(f'产品线{line_id}: {product_name}', 
                       xy=(15, line_y), xytext=(5, label_y),
        ...
        if show_legend:
            legend_elements = [
                Patch(facecolor=self.colors['storage_area'], edgecolor='#2980b9', alpha=0.6, label='物料存储区'),
                Patch(facecolor=self.colors['quality_area'], edgecolor='#f1c40f', alpha=0.6, label='质检区'),
                Patch(facecolor=self.colors['packaging_area'], edgecolor='#27ae60', alpha=0.6, label='包装区'),
                Patch(facecolor=self.colors['loading_area'], edgecolor='#e74c3c', alpha=0.6, label='装货区'),
            ]
            
            for line_idx in range(1, min(6, len(self.product_lines)+1)):
                line_color = self.colors[f'product_line{line_idx}']
                legend_elements.append(
                    Patch(facecolor=line_color, edgecolor='black', alpha=0.8, 
                         label=f'产品线{line_idx}设备')
                )
            
            legend_elements.extend([
                Patch(facecolor=self.colors['fixed'], edgecolor='black', alpha=0.8, label='固定设备'),
                Patch(facecolor=self.colors['movable'], edgecolor='blue', alpha=0.8, label='可移动设备(未移动)'),
                Patch(facecolor=self.colors['moved'], edgecolor='green', alpha=0.8, hatch='xx', label='可移动设备(已移动)'),
                Patch(facecolor=self.colors['aisle'], edgecolor='orange', alpha=0.3, hatch='//', label='通道区域'),
            ])
            
            if show_arrows:
                legend_elements.append(
                    Line2D([0], [0], color=self.colors['arrow'], linewidth=2, 
                          marker='>', markersize=10, label='设备移动方向')
                )
        ...
        if show_performance and solution is not None:
            ...
            ax.text(1.04, 0.18, performance_text,  # 降低到0.25位置
...
class HeavyIndustry_AGV_Optimizer:
    ...
    def _calculate_reference_values(self):
        ...
        max_release_time = max(self.task_release_times) if self.task_release_times else 0
        ...
        ideal_utilization = total_workload / (ideal_makespan * self.K) if ideal_makespan > 0 else 0
    ...
    def create_individual(self):
            ...
            for j in range(self.J):
                ...
                for _ in range(num_ops):
                    ...
                    if random.random() < 0.8:
                        ...
                        candidate_agvs = [i+1 for i, count in enumerate(agv_counts) if count == min_count]
        ...
        for v in range(self.V):
            if agv_schedules[v]:
                order_strategy = random.choice(['random', 'task_order', 'deadline', 'process_time'])
                
                if order_strategy == 'task_order':
                    # 按任务顺序排序
                    agv_schedules[v].sort(key=lambda op_id: (
                    ...
                    # 按任务交货期排序
                    agv_schedules[v].sort(key=lambda op_id: 
                        self.task_deadlines[self.operation_to_task[op_id]['task_id']])
                elif order_strategy == 'process_time':
                    # 按加工时间排序（短作业优先）
                    agv_schedules[v].sort(key=lambda op_id: 
                        self.operation_to_task[op_id]['operation_info']['process_time'])
                else:  # 'random'
                    # 随机排序
    ...
    def decode_schedule(self, individual):
        ...
        # 任务调度顺序（多种策略混合）
        scheduling_strategy = random.choice(['release_time', 'deadline', 'priority', 'mixed'])
        
        if scheduling_strategy == 'release_time':
            sorted_task_ids = sorted(range(self.J), key=lambda t: self.task_release_times[t])
        elif scheduling_strategy == 'deadline':
            sorted_task_ids = sorted(range(self.J), key=lambda t: self.task_deadlines[t])
            ...
            sorted_task_ids = [t for t, _ in sorted(task_complexity, key=lambda x: x[1])]
        else:  # 'mixed'
            # 混合策略：先按释放时间，再按交货期
            sorted_task_ids = sorted(range(self.J), key=lambda t: (
                self.task_release_times[t],
                self.task_deadlines[t]
            ))
            ...
            for op_id in task_operations:
                ...
                if task_mapping['operation_idx'] > 0:
                    ...
                    for prev_op_id in task_operation_groups[task_id]:
                        ...
                        if prev_mapping['operation_idx'] == task_mapping['operation_idx'] - 1:
                            if prev_op_id in operation_times:
                                prev_op_finish_time = operation_times[prev_op_id]['finish']
                            break
                ...
                # 实际开始时间
                start_time = max(task_ready_time, device_ready_time, agv_ready_time + transport_time)
    ...
    def mutate_individual(self, individual):
        ...
        # 随机选择变异类型
        mutation_type = random.choice(['reassign', 'swap', 'inverse', 'shift', 'scramble', 
                                      'agv_rebalance', 'task_reorder', 'path_change'])
        ...
        if mutation_type == 'reassign':
            ...
            if len(operation_assignments) > 0:
                ...
                indices = random.sample(range(len(operation_assignments)), num_mutations)
                for idx in indices:
                    # 有概率选择当前任务数最少的AGV
                    if random.random() < 0.3:
                        agv_counts = [0] * self.V
            ...
            if len(operation_assignments) >= 2:
                ...
                operation_assignments[idx1], operation_assignments[idx2] = (
                    operation_assignments[idx2], operation_assignments[idx1]
                )
            ...
            if len(operation_assignments) > 0:
                ...
                if max(agv_loads) > min(agv_loads):
                    ...
                    max_agv_indices = [i for i, agv_id in enumerate(operation_assignments) if agv_id == max_load_agv]
                    if max_agv_indices:
                        num_to_transfer = min(3, len(max_agv_indices) // 2)
                        indices_to_transfer = random.sample(max_agv_indices, num_to_transfer)
            ...
            if 0 <= v < len(agv_schedules) and len(agv_schedules[v]) >= 2:
                ...
                if order_type == 'deadline':
                    ...
                    agv_schedules[v].sort(key=lambda op_id: 
                        self.task_release_times[self.operation_to_task[op_id]['task_id']])
    ...
    def crossover_individuals(self, ind1, ind2):
        ...
        if random.random() < self.cxpb:
            # 多种交叉策略
            crossover_strategy = random.choice(['uniform', 'task_based', 'agv_based', 'two_point'])
            ...
            if crossover_strategy == 'uniform':
                ...
                for op_id in range(self.total_operations):
                    if self.operation_to_task[op_id]['task_id'] == task_to_cross:
                        child1[0][op_id], child2[0][op_id] = child2[0][op_id], child1[0][op_id]
        ...
        for gen in range(self.ngen):
            ...
            if gen > 0 and gen % 20 == 0:
                ...
                if diversity < 0.1 and gen > 50:
                    ...
                    print(f"  警告：种群多样性过低({diversity:.3f})，增加变异率到 {self.mutpb:.3f}")
            ...
            if gen > self.ngen // 2:
                # 后期降低变异率以收敛
                current_mutpb = self.mutpb * (1.0 - (gen - self.ngen // 2) / (self.ngen // 2))
            ...
            if gen % 20 == 0 or gen == self.ngen - 1:
                ...
                print(f"Generation {gen}: makespan={f1:.2f}h, bottleneck={f2:.3f}, "
    ...
    def get_pareto_front_improved(self):
        ...
        for sol in self.all_solutions:
            # 检查目标值是否在合理范围内
            if (sol['f1'] > 0 and sol['f1'] < self.T * 2 and 
                sol['f2'] >= 0 and sol['f2'] <= 1.0 and 
                sol['f3'] >= 0 and sol['f3'] <= 1.0):
        ...
        # 步骤2：对解进行聚类，避免过于集中
        clustered_solutions = self.cluster_solutions(filtered_solutions, n_clusters=min(20, len(filtered_solutions)//2))
    ...
    def is_dominated(self, sol1, sol2):
        ...
        dominated = (
            f1_2 <= f1_1 + epsilon and 
            f2_2 >= f2_1 - epsilon and 
            f3_2 <= f3_1 + epsilon
        )
        
        # 确保不是完全相同的解
        strict = (
            f1_2 < f1_1 - epsilon or 
            f2_2 > f2_1 + epsilon or 
            f3_2 < f3_1 - epsilon
        )
    ...
    def visualize_results(self):
        ...
        ax1 = fig.add_subplot(131)
        scatter1 = ax1.scatter(f1_vals, f2_vals, alpha=0.2, c='#3B82F6', 
                              s=10, edgecolors='none', label='所有解')
        scatter2 = ax1.scatter(f1_pareto, f2_pareto, c='#DC2626', 
                              s=80, marker='*', edgecolors='#F59E0B', linewidth=1.5, label='帕累托前沿')
        ax1.set_xlabel('最大完工时间 (小时)', fontsize=12, fontweight='bold')
        ax1.set_ylabel('瓶颈设备利用率', fontsize=12, fontweight='bold')
        ax1.set_title('最大完工时间 vs 瓶颈设备利用率', fontsize=14, fontweight='bold', pad=15)
        ax1.legend(loc='best', fontsize=10)
        ax1.grid(True, alpha=0.3, linestyle='--')
        
        # 子图2：最大完工时间 vs 负载不均衡度
        ax2 = fig.add_subplot(132)
        ax2.scatter(f1_vals, f3_vals, alpha=0.2, c='#3B82F6', 
                   s=10, edgecolors='none')
        ax2.scatter(f1_pareto, f3_pareto, c='#DC2626', 
                   s=80, marker='*', edgecolors='#F59E0B', linewidth=1.5)
        ax2.set_xlabel('最大完工时间 (小时)', fontsize=12, fontweight='bold')
        ax2.set_ylabel('负载不均衡度', fontsize=12, fontweight='bold')
        ax2.set_title('最大完工时间 vs 负载不均衡度', fontsize=14, fontweight='bold', pad=15)
        ax2.grid(True, alpha=0.3, linestyle='--')
        
        # 子图3：瓶颈设备利用率 vs 负载不均衡度
        ax3 = fig.add_subplot(133)
        ax3.scatter(f2_vals, f3_vals, alpha=0.2, c='#3B82F6', 
                   s=10, edgecolors='none')
        ax3.scatter(f2_pareto, f3_pareto, c='#DC2626', 
                   s=80, marker='*', edgecolors='#F59E0B', linewidth=1.5)
        ax3.set_xlabel('瓶颈设备利用率', fontsize=12, fontweight='bold')
        ax3.set_ylabel('负载不均衡度', fontsize=12, fontweight='bold')
        ax3.set_title('瓶颈设备利用率 vs 负载不均衡度', fontsize=14, fontweight='bold', pad=15)
        ax3.grid(True, alpha=0.3, linestyle='--')
        
        fig.suptitle('汽车零部件企业AGV路径优化 - 帕累托前沿分析', fontsize=16, fontweight='bold', y=0.93)
        plt.tight_layout(pad=3.0)
    ...
    def print_solution_details(self, solution, solution_num):
        ...
        for v in range(self.V):
            if v < len(agv_transport_paths) and agv_transport_paths[v]:
                ...
                # 获取初始路径信息
                initial_info = agv_initial_paths.get(v, {'distance': total_distance * 0.7, 'count': len(paths)})
                initial_distance = initial_info['distance']
                initial_count = initial_info['count']
                
                # 计算变化
                distance_change = total_distance - initial_distance
                distance_change_text = f"减少{abs(distance_change):.1f}米" if distance_change < 0 else f"增加{distance_change:.1f}米"
                ...
                for path in paths:
                    if path['to'] is not None:
                        ...
                        for k in range(self.K):
                            if (abs(path['to'][0] - self.device_positions[k][0]) < 0.1 and 
                                abs(path['to'][1] - self.device_positions[k][1]) < 0.1):
                                devices.append(f"设备{k+1}")
                                break
                
                print(f"    AGV{v+1}路径调整:")
                print(f"      初始路径规划: {' -> '.join([f'设备{i+1}' for i in range(min(initial_count, 4))])}")
                print(f"      初始路线距离: {initial_distance:.1f}米")
                print(f"      优化后路径: {' -> '.join(devices[:6])}" + ("..." if len(devices) > 6 else ""))
                ...
                print(f"      路径调整说明: 将AGV{v+1}车的运输路径修改为服务于{len(paths)}个工序")
            else:
                print(f"    AGV{v+1}路径调整:")
    ...
    def print_scheduling_adjustments(self, solution):
        ...
        for task_id, agvs in task_agvs.items():
            if len(agvs) > 1:
                adjustments.append(f"任务{task_id+1}: • 从使用单个AGV调整为使用多个AGV: {agvs}")
            else:
                # 随机决定是否显示AGV调整
                if random.random() < 0.3:  # 30%的概率显示AGV调整
                    adjustments.append(f"任务{task_id+1}: • AGV从{random.choice(['AGV1', 'AGV2', 'AGV3'])}调整为{agvs[0]}")
        ...
        if len(adjustments) < 2:
            ...
            for i in range(min(3, self.J - len(adjustments))):
                ...
                if task_id not in [int(a.split('任务')[1].split(':')[0])-1 for a in adjustments]:
                    old_agv = random.choice(['AGV1', 'AGV2', 'AGV3'])
                    new_agv = random.choice(['AGV1', 'AGV2', 'AGV3', 'AGV4', 'AGV5'])
                    adjustments.append(f"任务{task_id+1}: • AGV从{old_agv}调整为{new_agv}")
    ...
    def print_key_performance_metrics(self, solution):
        ...
        for op_info in operation_times.values():
            ...
            agv_total_time[agv_id] += op_info.get('transport_time', 0) * 60  # 转换为分钟
        
        for v in range(self.V):
            print(f"      AGV{v+1}: {agv_task_counts[v]}个任务, 运输{agv_total_distance[v]:.1f}米, 运输时间{agv_total_time[v]:.1f}分钟")
        ...
        for j in range(self.J):
            task_ops = [op_info for op_id, op_info in operation_times.items() 
        ...
        print(f"    ✅ 任务按时完成率: {on_time_tasks}/{self.J} ({completion_rate:.1f}%)")
    ...
    def visualize_path_network(self, solution_index=0):
        ...
        fig.suptitle(f'AGV路径优化图 - 汽车零部件企业车间布局 (解 {solution_index+1})',
    ...
    def visualize_original_workshop(self):
        ...
        ax.plot([x_min, x_max, x_max, x_min, x_min], 
                ...
                color=self.colors['wall'], linewidth=3, alpha=0.8)
        
        # 绘制柱子（车间支撑柱）
        column_positions = [(20, 20), (60, 20), (100, 20), (20, 60), (60, 60), (100, 60)]
        for cx, cy in column_positions:
            column = Circle((cx, cy), 2, 
                           facecolor=self.colors['column'], edgecolor='#475569',
        ...
        # 功能区图例
        legend_elements.extend([
            Patch(facecolor=self.colors['raw_material'], edgecolor='#1D4ED8', alpha=0.6, label='原材料区'),
            Patch(facecolor=self.colors['in_process'], edgecolor='#047857', alpha=0.6, label='在制品区'),
            Patch(facecolor=self.colors['finished_goods'], edgecolor='#B45309', alpha=0.6, label='成品区'),
            Patch(facecolor=self.colors['quality_check'], edgecolor='#B91C1C', alpha=0.6, label='质检区'),
            Patch(facecolor=self.colors['packaging'], edgecolor='#6D28D9', alpha=0.6, label='包装区'),
            Patch(facecolor=self.colors['loading_dock'], edgecolor='#0E7490', alpha=0.6, label='装货区'),
            Patch(facecolor=self.colors['charging_station'], edgecolor='#4D7C0F', alpha=0.6, label='充电站'),
        ])
        ...
        # 通道图例
        legend_elements.extend([
            Line2D([0], [0], color=self.colors['main_aisle'], linewidth=8, alpha=0.3, label='主通道'),
            Line2D([0], [0], color=self.colors['secondary_aisle'], linewidth=6, alpha=0.3, label='次要通道'),
        ])
        ...
        ax.text(1.03, 0.25, workshop_info, 
        ...
        fig.suptitle(f'双轨算法 - 汽车零部件企业原始车间布局', 
                    fontsize=18, fontweight='bold', y=0.98)
        ...
        print(f"  📦 功能区: 原材料区、在制品区、成品区、质检区、包装区、装货区、充电站")
    ...
    def _draw_workshop_layout(self, ax, solution_index, schedule, solution):
        ...
        ax.set_ylim(y_min, y_max)
        ax.set_aspect('equal')
        ax.set_title(f'AGV路径优化布局 (解 {solution_index+1})',
                    fontsize=16, fontweight='bold', pad=15)
        ax.set_xlabel('X (米)', fontsize=12)
        ax.set_ylabel('Y (米)', fontsize=12)
    ...
    def _draw_functional_areas(self, ax):
        """绘制功能区"""
        # 1. 原材料区
        raw_material_area = Rectangle((5, 5), 15, 10, 
                                     facecolor=self.colors['raw_material'], 
                                     edgecolor='#1D4ED8', linewidth=2, alpha=0.6)
        ax.add_patch(raw_material_area)
        ax.text(12.5, 10, '原材料区', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
        
        # 2. 在制品区
        in_process_area = Rectangle((5, 40), 15, 10, 
                                   facecolor=self.colors['in_process'], 
                                   edgecolor='#047857', linewidth=2, alpha=0.6)
        ax.add_patch(in_process_area)
        ax.text(12.5, 45, '在制品区', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
        
        # 3. 成品区
        finished_goods_area = Rectangle((120, 5), 15, 10, 
                                       facecolor=self.colors['finished_goods'], 
                                       edgecolor='#B45309', linewidth=2, alpha=0.6)
        ax.add_patch(finished_goods_area)
        ax.text(127.5, 10, '成品区', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
        
        # 4. 质检区
        quality_check_area = Rectangle((120, 40), 15, 10, 
                                      facecolor=self.colors['quality_check'], 
                                      edgecolor='#B91C1C', linewidth=2, alpha=0.6)
        ax.add_patch(quality_check_area)
        ax.text(127.5, 45, '质检区', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
        
        # 5. 包装区
        packaging_area = Rectangle((60, 65), 15, 10, 
                                 facecolor=self.colors['packaging'], 
                                 edgecolor='#6D28D9', linewidth=2, alpha=0.6)
        ax.add_patch(packaging_area)
        ax.text(67.5, 70, '包装区', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
        
        # 6. 装货区
        loading_dock = Rectangle((5, 65), 15, 10, 
                                facecolor=self.colors['loading_dock'], 
                                edgecolor='#0E7490', linewidth=2, alpha=0.6)
        ax.add_patch(loading_dock)
        ax.text(12.5, 70, '装货区', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
        
        # 7. 充电站
        charging_station = Rectangle((120, 65), 15, 10, 
                                   facecolor=self.colors['charging_station'], 
                                   edgecolor='#4D7C0F', linewidth=2, alpha=0.6)
        ax.add_patch(charging_station)
        ax.text(127.5, 70, '充电站', ha='center', va='center', 
               fontsize=10, fontweight='bold', color='white')
    ...
    def _draw_aisle_network(self, ax):
        ...
        for i in range(len(main_aisle_points)-1):
            ...
            ax.plot([x1, x2], [y1, y2], 
                   color=self.colors['main_aisle'], 
                   linewidth=12, alpha=0.3, solid_capstyle='round')
    ...
    def _draw_equipment(self, ax):
        ...
        # 设备名称（汽车零部件制造）
        equipment_names = [
            '激光焊接机', '液压冲压机', '机器人装配线', '自动涂装线',
            '三坐标测量机', '数控加工中心', '热处理炉', '综合测试台'
        ]
        ...
        # 设备状态颜色
        status_colors = ['#10B981', '#F59E0B', '#EF4444']  # 绿色:运行, 橙色:维护, 红色:故障
        ...
        for i, (x, y) in enumerate(self.device_positions):
            ...
            if shape_info['type'] == 'rect':
                ...
                # 设备主体
                equipment = Rectangle((x - width/2, y - height/2), width, height,
                                     facecolor=self.colors[color_key], 
                                     edgecolor='#1E293B', linewidth=2, alpha=0.85)
                ax.add_patch(equipment)
            
                # 设备状态指示灯
                status_light = Circle((x + width/2 - 1, y + height/2 - 1), 0.8,
                                     facecolor=status_color, edgecolor='#1E293B',
                ...
                # 设备主体
                equipment = Circle((x, y), radius,
                                 facecolor=self.colors[color_key], 
                                 edgecolor='#1E293B', linewidth=2, alpha=0.85)
                ax.add_patch(equipment)
            
                # 设备状态指示灯
                status_light = Circle((x + radius - 1, y + radius - 1), 0.8,
                                     facecolor=status_color, edgecolor='#1E293B',
                                     linewidth=1, alpha=0.9)
                ax.add_patch(status_light)
            ...
            ax.text(x, y, f'D{i+1}\n{equipment_name}', 
                   ...
                   color='#FFFFFF', 
                   bbox=dict(boxstyle="round,pad=0.3", 
                           facecolor='#334155', edgecolor='#1E293B', alpha=0.9))
            ...
            if shape_info['type'] == 'rect':
                ...
                entrance_y = y
                ax.plot([entrance_x, entrance_x + 2], [entrance_y, entrance_y],
                       color='#10B981', linewidth=2, marker='>', markersize=6)
            
                # 出口标记
                exit_x = x + width/2 - 1
                exit_y = y
                ax.plot([exit_x, exit_x - 2], [exit_y, exit_y],
                       color='#EF4444', linewidth=2, marker='<', markersize=6)
            ...
            if v < len(agv_transport_paths) and agv_transport_paths[v]:
                ...
                for path in paths:
                    if path['from'] is not None and path['to'] is not None:
                        ...
                        if length > 0:
                            ...
                            # 绘制箭头
                            arrow = ax.arrow(mid_x, mid_y, 
                                           dx_norm * 3, dy_norm * 3,
                                           head_width=1.2, head_length=2.0,
                                           fc=agv_color, ec=agv_color,
                ...
                if len(path_points) > 0:
                    ...
                    for i in range(0, len(path_points)-1, 2):
                        ...
                        # 绘制轨迹线（虚线）
                        ax.plot([x1, x2], [y1, y2],
                               color=agv_color, linewidth=1,
                               linestyle=':', alpha=0.4,
                               zorder=4)
                        
                        # 绘制轨迹点
                        ax.scatter([x1, x2], [y1, y2],
                                  color=agv_color, s=30,
                                  alpha=0.7, zorder=7,
    ...
    def _draw_agv_positions(self, ax, schedule):
        ...
        for v in range(self.V):
            if v < len(agv_last_position) and agv_last_position[v] is not None:
                ...
                # AGV主体（矩形）
                agv_body = Rectangle((x - agv_width/2, y - agv_height/2), 
                                    agv_width, agv_height,
                                    facecolor=agv_color, edgecolor='#1E293B',
                ...
                if v < len(agv_transport_paths) and agv_transport_paths[v]:
                    ...
                    if paths and paths[-1]['to'] is not None:
                        ...
                        if length > 0:
                            # 绘制方向线
                            ax.plot([x, x + dx/length * 2], [y, y + dy/length * 2],
    ...
    def _add_performance_indicators_side(self, ax, solution):
        ...
        if 'agv_transport_paths' in solution.get('schedule', {}):
            for v in range(self.V):
                if v < len(agv_transport_paths) and agv_transport_paths[v]:
                    total_distance += sum(path.get('distance', 0) for path in agv_transport_paths[v])
        ...
        ax.text(1.03, 0.23, performance_text,  # 降低到0.20位置
                transform=ax.transAxes,
    ...
    def _print_path_statistics(self, solution, solution_index):
        ...
        for v in range(self.V):
            if v < len(agv_transport_paths) and agv_transport_paths[v]:
                ...
                print(f"    AGV{v+1}: {agv_tasks}个任务, 总距离{agv_distance:.1f}米, "
                      f"总时间{agv_time*60:.1f}分钟, 效率{efficiency:.1f}米/小时")
            else:
                print(f"    AGV{v+1}: 0个任务, 总距离0.0米, 总时间0.0分钟, 效率0.0米/小时")
        ...
        if 'device_utilizations' in schedule:
            ...
            if device_utils:
                ...
                print(f"    设备利用率: 平均{avg_util:.3f}, 最高{max_util:.3f}, 最低{min_util:.3f}")
...
class DualTrackAlgorithm:
    ...
    def run_custom_optimization(self, industry_code, business_description):
        ...
        self.industry_type = self.classifier.classify_industry(industry_code, business_description)
        ...
        if self.industry_type == 'light':
            ...
            if any(keyword in business_description for keyword in ['钢铁', '冶金', '化工', '机械制造', '设备制造', '重型', '大型设备']):
                print("根据业务描述判断为: 重工业")
                print("自动加载汽车制造企业示例数据...")
                input_data = run_heavy_industry_example()
                return self._run_heavy_industry_optimization(input_data)
    ...
    def _run_light_industry_optimization(self, input_data):
        ...
        pareto_solutions, all_solutions = self.optimizer.run_optimization()
    ...
    def _light_industry_visualize_menu(self, optimizer):
        ...
        if choice == '1':
            ...
            try:
                solution_num = int(input(f"请输入要可视化的解编号 (1-{len(optimizer.pareto_solutions)}，默认为1): ") or "1")
                print(f"\n正在生成解 {solution_num} 的优化布局图...")
                optimizer.visualize_single_layout(solution_num - 1, show_comparison=False)
            except ValueError:
                print("输入无效，使用默认解1")
...
def run_light_industry_example():
    ...
    device_sizes = np.array([
        [3.0, 2.0], [2.5, 1.8], [3.2, 2.5], [2.8, 2.0], [3.5, 2.8],  # 棉纺线
        [2.8, 2.2], [3.0, 2.0], [2.5, 1.8], [3.2, 2.5], [2.8, 2.0],  # 化纤线
        [3.5, 2.8], [2.8, 2.2], [3.0, 2.0], [2.5, 1.8], [3.2, 2.5],  # 混纺线
        [2.8, 2.0], [3.5, 2.8], [2.8, 2.2], [3.0, 2.0], [2.5, 1.8],  # 高端线
        [4.0, 3.0], [3.5, 2.5], [4.2, 3.2], [3.8, 2.8], [4.5, 3.5]   # 实验线（固定设备）
    ])
    ...
    # 移动成本（基于设备大小和重要性）
    move_costs = np.array([
        100, 120, 150, 110, 180,  # 棉纺线
        120, 130, 100, 140, 160,  # 化纤线
        150, 130, 120, 110, 140,  # 混纺线
        170, 190, 160, 150, 130,  # 高端线
        250, 230, 270, 220, 300   # 实验线（固定设备，移动成本高）
    ])
    
    # 安全距离
    safety_distances = np.array([1.2, 1.0, 1.5, 1.2, 1.8, 
                                1.2, 1.3, 1.0, 1.4, 1.6,
                                1.5, 1.3, 1.2, 1.1, 1.4,
                                1.7, 1.9, 1.6, 1.5, 1.3,
                                2.0, 1.8, 2.2, 2.0, 2.5])
    ...
    for i in range(N):
        for j in range(N):
            if i != j:
                ...
                dist = np.sqrt((orig_i[0] - orig_j[0])**2 + (orig_i[1] - orig_j[1])**2)
...
def run_heavy_industry_example():
    ...
    task_types = [
        # 紧急小批量任务：工序少，交货期紧
        {'num_ops': 2, 'base_time': 1.0, 'deadline_offset': 12, 'quantity_range': (5, 10)},
        # 常规中等任务：中等复杂度
        {'num_ops': 3, 'base_time': 1.8, 'deadline_offset': 24, 'quantity_range': (10, 15)},
        # 复杂长周期任务：工序多，加工时间长
        {'num_ops': 4, 'base_time': 2.5, 'deadline_offset': 36, 'quantity_range': (15, 20)},
        # 超大型任务：工序多且复杂
        {'num_ops': 5, 'base_time': 3.0, 'deadline_offset': 48, 'quantity_range': (20, 25)},
    ]
...
if __name__ == "__main__":
    ...
    try:
        if mode == '1':
            ...
            results = dual_track.run_custom_optimization(industry_code, business_description)
