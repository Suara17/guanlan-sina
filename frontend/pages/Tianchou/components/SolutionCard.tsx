    ...
    >
      ...
      <div className="space-y-1 text-sm mb-4">
        <div className="flex justify-between items-center py-1 border-b border-slate-100">
          ...
          <span className="font-medium text-slate-700">¥{solution.total_cost.toLocaleString()}</span>
        </div>
        <div className="flex justify-between items-center py-1 border-b border-slate-100">
          <span className="text-slate-500 text-xs">工期</span>
          <span className="font-medium text-slate-700">{solution.implementation_days.toFixed(1)} 天</span>
        </div>
