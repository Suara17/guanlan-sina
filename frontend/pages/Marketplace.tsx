import { Check, Cpu, Eye, LineChart, Network, ShoppingBag } from 'lucide-react'
...
const CAPABILITIES: Capability[] = [
  ...
  },
  {
    id: '4',
    title: '浑天·仿真推演',
    description: '数字孪生仿真环境，零成本验证生产策略变更。',
    category: 'Simulation',
    price: '¥2,000/月',
    subscribed: false,
    iconName: 'LineChart',
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {CAPABILITIES.map((cap) => {
          ...
          return (
            <div
              key={cap.id}
              className="bg-white rounded-xl border border-slate-100 shadow-sm hover:shadow-lg transition-all duration-300 flex flex-col overflow-hidden group"
            >
