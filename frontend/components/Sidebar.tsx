...
const Sidebar: React.FC<SidebarProps> = ({ currentPath, onNavigate, isOpen }) => {
  return (
    <aside
      className={`fixed lg:relative z-30 w-64 h-full bg-slate-900 text-white transition-all duration-300 flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}
    >
