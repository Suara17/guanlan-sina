...
export const TOUR_STEPS: TourStep[] = [
  ...
  {
    id: 'components-group',
    target: '[data-tour="components-group"]',
    title: '组件管理',
    description: '模块化能力订阅与业务流程编排，灵活扩展系统能力。',
    position: 'right',
    ...
    features: [
      {
        ...
        title: '能力商店',
        description: '订阅视觉算法、优化引擎等模块',
      },
      {
        icon: <Cuboid className="w-4 h-4 text-blue-500" />,
        title: '场景编排',
        description: '可视化拖拽编排业务流程',
      },
      {
        icon: <Play className="w-4 h-4 text-purple-500" />,
        title: '开发者生态',
        description: 'API、SDK与沙箱环境',
      },
    ],
  },
  {
